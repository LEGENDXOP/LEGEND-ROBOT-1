...
import heroku3
from LEGEND import OWNER_ID, update
...
async def upstream(ups):
    ...
    try:
        ...
        if conf != "now":
            await lol.edit(
                f"**Unfortunately, the directo
ry {error} does not seem to be a git repository.\
    ...
    changelog = await gen
_chlog(repo, f"HEAD..upstream/{ac_br}")
...
nning ....`")
    ...
    if HEROKU_API_KEY is not None:
        ...
        heroku_git_url = heroku_app.git_url.replac
e(
